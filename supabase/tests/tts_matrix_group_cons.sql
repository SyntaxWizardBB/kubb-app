-- =====================================================================
-- Tournament Testing Suite (TTS) — CONFIG MATRIX shard: group_phase rows G49..G72 (consolation).
--
...
-- This shard drives the 24 group_phase consolation combos G49..G72 (A3×A4×A5×A6), both A6 endpoints (SPEC §5/DoD-06) end-to-end through the real RPCs and triggers via
...
BEGIN
  ...
  -- Enter the KO phase. created_by + ko_config als postgres lesen, danach in
  -- die Organisator-Rolle für den SECURITY-DEFINER-RPC wechseln.
  PERFORM _tts_as_pg();
  SELECT created_by, ko_config INTO v_ko_org, v_ko_cfg
    FROM public.tournaments WHERE id = v_tid;
  PERFORM _tts_as(v_ko_org);
...
-- ---------------------------------------------------------------------
-- §2.A group_phase rows G49..G72 (consolation) @ default N=32.
-- ---------------------------------------------------------------------
-- G49 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|ekc|snake|target_to_consolation', 32);
-- G50 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|ekc|seeded|target_to_consolation', 32);
-- G51 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|ekc|random|target_to_consolation', 32);
-- G52 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|classic|snake|target_to_consolation', 32);
-- G53 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|classic|seeded|target_to_consolation', 32);
-- G54 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|classic|random|target_to_consolation', 32);
-- G55 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|ekc|snake|target_to_consolation', 32);
-- G56 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|ekc|seeded|target_to_consolation', 32);
-- G57 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|ekc|random|target_to_consolation', 32);
-- G58 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|classic|snake|target_to_consolation', 32);
-- G59 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|classic|seeded|target_to_consolation', 32);
-- G60 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|classic|random|target_to_consolation', 32);
-- G61 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|classic_kingtoss_removal|ekc|snake|target_to_consolation', 32);
-- G62 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|classic_kingtoss_removal|ekc|seeded|target_to_consolation', 32);
-- G63 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|classic_kingtoss_removal|ekc|random|target_to_consolation', 32);
-- G64 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|classic_kingtoss_removal|classic|snake|target_to_consolation', 32);
-- G65 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|classic_kingtoss_removal|classic|seeded|target_to_consolation', 32);
-- G66 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|classic_kingtoss_removal|classic|random|target_to_consolation', 32);
-- G67 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|mighty_finisher_shootout|ekc|snake|target_to_consolation', 32);
-- G68 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|mighty_finisher_shootout|ekc|seeded|target_to_consolation', 32);
-- G69 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|mighty_finisher_shootout|ekc|random|target_to_consolation', 32);
-- G70 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|mighty_finisher_shootout|classic|snake|target_to_consolation', 32);
-- G71 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|mighty_finisher_shootout|classic|seeded|target_to_consolation', 32);
-- G72 (N=32) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|one_vs_two|mighty_finisher_shootout|classic|random|target_to_consolation', 32);
...
-- G49 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|ekc|snake', 32);
-- G50 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|ekc|seeded', 32);
-- G51 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|ekc|random', 32);
-- G52 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|classic|snake', 32);
-- G53 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|classic|seeded', 32);
-- G54 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|classic|random', 32);
-- G55 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|ekc|snake', 32);
-- G56 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|ekc|seeded', 32);
-- G57 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|ekc|random', 32);
-- G58 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|classic|snake', 32);
-- G59 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|classic|seeded', 32);
-- G60 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|mighty_finisher_shootout|classic|random', 32);
-- G61 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|classic_kingtoss_removal|ekc|snake', 32);
-- G62 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|classic_kingtoss_removal|ekc|seeded', 32);
-- G63 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|classic_kingtoss_removal|ekc|random', 32);
-- G64 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|classic_kingtoss_removal|classic|snake', 32);
-- G65 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|classic_kingtoss_removal|classic|seeded', 32);
-- G66 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|classic_kingtoss_removal|classic|random', 32);
-- G67 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|mighty_finisher_shootout|ekc|snake', 32);
-- G68 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|mighty_finisher_shootout|ekc|seeded', 32);
-- G69 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|mighty_finisher_shootout|ekc|random', 32);
-- G70 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|mighty_finisher_shootout|classic|snake', 32);
-- G71 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|mighty_finisher_shootout|classic|seeded', 32);
-- G72 (N=32) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|one_vs_two|mighty_finisher_shootout|classic|random', 32);

-- §0.3 larger-size regime subset (N=48 / N=60) for this slice (DoD-05).
-- G49 (N=48) consolation-path: target -> consolation final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|ekc|snake|target_to_consolation', 48);
-- G49 (N=48) consolation main-path: target -> MAIN final (SPEC §5/A6 endpoint 1).
SELECT * FROM _tts_run_cons_main('group_phase|consolation|seed_high_vs_low|classic_kingtoss_removal|ekc|snake', 48);
