-- =====================================================================
-- Tournament Testing Suite (TTS) — CONFIG MATRIX shard: group_phase rows G01..G24 (single_out).
--
...
-- This shard drives the 24 group_phase single_out combos G01..G24 (A3×A4×A5×A6) end-to-end through the real RPCs and triggers via
...
-- the execution path).
-- Deliverable name per the block brief: this file is literally config_matrix_test.sql.
--
...
-- ---------------------------------------------------------------------
-- §2.A group_phase rows G01..G24 (single_out) @ default N=32.
-- ---------------------------------------------------------------------
-- G01 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|classic_kingtoss_removal|ekc|snake', 32);
-- G02 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|classic_kingtoss_removal|ekc|seeded', 32);
-- G03 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|classic_kingtoss_removal|ekc|random', 32);
-- G04 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|classic_kingtoss_removal|classic|snake', 32);
-- G05 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|classic_kingtoss_removal|classic|seeded', 32);
-- G06 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|classic_kingtoss_removal|classic|random', 32);
-- G07 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|mighty_finisher_shootout|ekc|snake', 32);
-- G08 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|mighty_finisher_shootout|ekc|seeded', 32);
-- G09 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|mighty_finisher_shootout|ekc|random', 32);
-- G10 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|mighty_finisher_shootout|classic|snake', 32);
-- G11 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|mighty_finisher_shootout|classic|seeded', 32);
-- G12 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|mighty_finisher_shootout|classic|random', 32);
-- G13 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|classic_kingtoss_removal|ekc|snake', 32);
-- G14 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|classic_kingtoss_removal|ekc|seeded', 32);
-- G15 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|classic_kingtoss_removal|ekc|random', 32);
-- G16 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|classic_kingtoss_removal|classic|snake', 32);
-- G17 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|classic_kingtoss_removal|classic|seeded', 32);
-- G18 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|classic_kingtoss_removal|classic|random', 32);
-- G19 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|mighty_finisher_shootout|ekc|snake', 32);
-- G20 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|mighty_finisher_shootout|ekc|seeded', 32);
-- G21 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|mighty_finisher_shootout|ekc|random', 32);
-- G22 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|mighty_finisher_shootout|classic|snake', 32);
-- G23 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|mighty_finisher_shootout|classic|seeded', 32);
-- G24 (N=32) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|one_vs_two|mighty_finisher_shootout|classic|random', 32);

-- §0.3 larger-size regime subset (N=48 / N=60) for this slice (DoD-05).
-- G01 (N=48) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|classic_kingtoss_removal|ekc|snake', 48);
-- G02 (N=60) single_out: target -> final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|single_out|seed_high_vs_low|classic_kingtoss_removal|ekc|seeded', 60);
