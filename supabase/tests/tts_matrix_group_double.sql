-- =====================================================================
-- Tournament Testing Suite (TTS) — CONFIG MATRIX shard: group_phase rows G25..G48 (double_out).
--
...
-- This shard drives the 24 group_phase double_out combos G25..G48 (A3×A4×A5×A6) end-to-end through the real RPCs and triggers via
...
-- ---------------------------------------------------------------------
-- §2.A group_phase rows G25..G48 (double_out) @ default N=32.
-- ---------------------------------------------------------------------
-- G25 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|classic_kingtoss_removal|ekc|snake', 32);
-- G26 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|classic_kingtoss_removal|ekc|seeded', 32);
-- G27 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|classic_kingtoss_removal|ekc|random', 32);
-- G28 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|classic_kingtoss_removal|classic|snake', 32);
-- G29 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|classic_kingtoss_removal|classic|seeded', 32);
-- G30 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|classic_kingtoss_removal|classic|random', 32);
-- G31 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|mighty_finisher_shootout|ekc|snake', 32);
-- G32 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|mighty_finisher_shootout|ekc|seeded', 32);
-- G33 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|mighty_finisher_shootout|ekc|random', 32);
-- G34 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|mighty_finisher_shootout|classic|snake', 32);
-- G35 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|mighty_finisher_shootout|classic|seeded', 32);
-- G36 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|mighty_finisher_shootout|classic|random', 32);
-- G37 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|classic_kingtoss_removal|ekc|snake', 32);
-- G38 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|classic_kingtoss_removal|ekc|seeded', 32);
-- G39 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|classic_kingtoss_removal|ekc|random', 32);
-- G40 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|classic_kingtoss_removal|classic|snake', 32);
-- G41 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|classic_kingtoss_removal|classic|seeded', 32);
-- G42 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|classic_kingtoss_removal|classic|random', 32);
-- G43 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|mighty_finisher_shootout|ekc|snake', 32);
-- G44 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|mighty_finisher_shootout|ekc|seeded', 32);
-- G45 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|mighty_finisher_shootout|ekc|random', 32);
-- G46 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|mighty_finisher_shootout|classic|snake', 32);
-- G47 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|mighty_finisher_shootout|classic|seeded', 32);
-- G48 (N=32) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|mighty_finisher_shootout|classic|random', 32);

-- §0.3 larger-size regime subset (N=48 / N=60) for this slice (DoD-05).
-- G25 (N=48) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|seed_high_vs_low|classic_kingtoss_removal|ekc|snake', 48);
-- G37 (N=60) double_out: target -> grand final (SPEC §5/A6).
SELECT * FROM _tts_run('group_phase|double_out|one_vs_two|classic_kingtoss_removal|ekc|snake', 60);
