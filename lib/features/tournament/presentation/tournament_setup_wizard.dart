...
class _TournamentSetupWizardState extends ConsumerState<TournamentSetupWizard> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // P2.4: in stage-graph mode, apply the graph to the tournament after
      // creation. Either apply a chosen template (appliedTemplateId) or
      // auto-save the free graph and apply it. Classic mode does nothing.
      // Failures are tolerated (like _sendInvites) — tournament is already
      // created; the organizer can retry from the detail screen.
